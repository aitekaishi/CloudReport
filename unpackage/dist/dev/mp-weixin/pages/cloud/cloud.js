...
//
//
var _default = { data: function data() {return { aindex: 2, namea: " ", supervisordate: '', SupervisionSubItem: [], SupervisionSubItemimage: [], reportContent: [], hegenum: 0, buhegenum: 0, numarraya: [], numarrayb: [], numarrayc: [], numarrayd: [], buhegeindex: -1, hegeindex: -1 };}, onLoad: function onLoad() {var _this = this;console.log('xxx');console.log(uni.getStorageSync('title'));uni.setNavigationBarTitle({ title: uni.getStorageSync('title') }); /* uni.setStorageSync('numarraydd',_this.numarrayd)
